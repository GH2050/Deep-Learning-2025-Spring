...
\hline
1 & ResNet-56 \cite{He2016Deep} & \textbf{72.50} & 0.86 & 84.30 \\
2 & \textcolor{red}{\texttt{improved\_resnet20\_convnext}}* & 72.33 & \textbf{0.175} & \textbf{413.31} \\
3 & ECA-ResNet-32 \cite{Wang_2020_CVPR} & 71.00 & 0.47 & 151.06 \\
4 & ResNet-32 \cite{He2016Deep} & 69.50 & 0.47 & 147.87 \\
5 & ECANet-20 (adaptive) \cite{Wang_2020_CVPR} & 68.08 & 0.278 & 244.89 \\
\hline
\end{tabular}
